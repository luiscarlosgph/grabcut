...
As shown above, it is not mandatory to provide sure foreground and sure background. Either of the two is sufficient (sure foreground in the example above). 
