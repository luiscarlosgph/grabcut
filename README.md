...
It is not mandatory to provide sure foreground and sure background. Either of the two is sufficient (e.g. sure foreground in the example above) although performance may vary.
